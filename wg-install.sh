...
net.ipv6.conf.all.forwarding = 0" >/etc/sysctl.d/wg.conf
	...
	# Prevent interdevice communications
...
Endpoint = ${ENDPOINT}
AllowedIPs = ${SERVER_WG_IPV4},${SERVER_WG_IPV6}
...
AllowedIPs = ${CLIENT_WG_IPV4}/32,${CLIENT_WG_IPV6}/128" >>"/etc/wireguard/${SERVER_WG_NIC}.conf"
	...
	echo "Config file for ${CLIENT_NAME} is available in ${HOME_DIR}/${SERVER_WG_NIC}-client-${CLIENT_NAME}.conf"
}
